...
```bash
cd tutorial/level_2/M7_deployment/1_serving_deep_dive
uv sync
...
Done! Check the MLflow UI at http://127.0.0.1:5000
  Experiment: L2/M7_deployment/1_serving_deep_dive
...
- Experiment **L2/M7_deployment/1_serving_deep_dive** with three runs
