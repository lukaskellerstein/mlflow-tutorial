"""L2-M6.1 — AI Gateway Overview: unified LLM endpoint management,
...
def main() -> None:
    ...
    print("In L2-M6.2, we'll dive into gateway routing and fallbacks.\n")

if __name__ == "__main__":
    mlflow.set_tracking_uri("http://127.0.0.1:5000")
    mlflow.set_experiment("L2/M6_ai_gateway/1_ai_gateway_overview")
    main()
