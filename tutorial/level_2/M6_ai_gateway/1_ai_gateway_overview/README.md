...
```bash
cd tutorial/level_2/M6_ai_gateway/1_ai_gateway_overview
uv sync
...
In the MLflow UI, open the experiment "L2/M6_ai_gateway/1_ai_gateway_overview" to see:
...
Continue to **L2-M6.2 (Gateway Configuration and Routing)** to dive into advanced endpoint configuration with fallback chains, traffic splitting, and cost management.
