...
```bash
cd tutorial/level_1_models/M4_evaluation/2_genai_custom_metrics
uv sync
...
In the MLflow UI, navigate to experiment **L1/M4_evaluation/2_genai_custom_metrics** to see one run per configuration with all metrics, scorer values, and rationales.
