...
def main() -> None:
    ...
    print("=" * 60)
    print("L1-M4.2.2 — RAG System Evaluation")
    print("=" * 60)
    print()
    ...
    print("  Experiment: L1/M4_evaluation/2_offline/2_rag_evaluation")
    print("=" * 60)


if __name__ == "__main__":
    mlflow.set_tracking_uri("http://127.0.0.1:5555")
    mlflow.set_experiment("L1/M4_evaluation/2_offline/2_rag_evaluation")
    main()
