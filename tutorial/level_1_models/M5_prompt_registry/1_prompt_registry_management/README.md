...
```bash
cd tutorial/level_1_models/M5_prompt_registry/1_prompt_registry_management
uv sync
...
In L1-M7.1 (Prompt Optimization), you will go beyond manual A/B testing and explore systematic prompt tuning using evaluation metrics as the optimization target.
