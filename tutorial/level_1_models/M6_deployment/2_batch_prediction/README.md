...
- `load_context` -- initializes the OpenAI client pointing at the MLflow AI Gateway.
...
class LLMModel(mlflow.pyfunc.PythonModel):
    def load_context(self, context):
        ...
        self.client = OpenAI(base_url="http://127.0.0.1:5555/gateway/mlflow/v1", api_key="not-needed")
