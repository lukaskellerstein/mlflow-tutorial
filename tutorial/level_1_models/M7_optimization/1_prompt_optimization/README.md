...
```bash
cd tutorial/level_1_models/M7_optimization/1_prompt_optimization
uv sync
...
For deeper evaluation techniques, see L2-M3 (Deep Evaluation). Dataset logging and lineage are covered in L1-M4.2.3 (Datasets).
