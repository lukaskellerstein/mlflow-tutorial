# L2-M3.3 — Building a Custom Domain-Specific Agent Benchmark
...
- Completed: L2-M3.1 (SWE-Bench) and L2-M3.2 (GAIA) for benchmark harness patterns
...
```bash
cd tutorial/level_2_agents/M3_agent_benchmarks/3_custom_benchmark
uv sync
...
```text
============================================================
L2-M3.3 -- Custom Domain-Specific Agent Benchmark
============================================================
...
- Tighten the scoring — replace exact-match with an LLM judge (L2-M2.2) for phrasing-tolerant evaluation
