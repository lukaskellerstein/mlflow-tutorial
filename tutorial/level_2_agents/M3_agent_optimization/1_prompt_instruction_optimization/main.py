...
mlflow.set_experiment("L2/M3_agent_optimization/1_prompt_instruction_optimization")
...
def register_base_prompt() -> str:
    ...
    version = mlflow.genai.register_prompt(
        ...
        commit_message="L2-M3.1 starting point: the minimal prompt",
    )
...
def run_automated_optimization() -> dict[str, Any]:
    ...
    optimizer = MetaPromptOptimizer(reflection_model=f"openai:/{JUDGE_ALIAS}")
...
def main() -> None:
    print("=" * 70)
    print("  L2-M3.1 — Agent Optimization")
