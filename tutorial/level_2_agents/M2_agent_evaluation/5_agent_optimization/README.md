...
- Completed: L2-M2.4 (Architecture Comparison), L2-M2.2 (Judges)
...
```bash
cd tutorial/level_2_agents/M2_agent_evaluation/5_agent_optimization
uv sync
...
In the MLflow UI:
- Navigate to experiment `L2/M2_agent_evaluation/4_agent_optimization`
