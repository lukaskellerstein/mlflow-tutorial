...
- Completed: L2-M1.1 (LangChain + LangGraph Agents), L1-M4.1.1 (Evaluation Fundamentals)
...
```bash
cd tutorial/level_2_agents/M2_agent_evaluation/1_instruments/1_agent_testing
uv sync
...
**L2-M2.1.2 (Judges for Agents: Inline, Registered, Aligned)** builds the
