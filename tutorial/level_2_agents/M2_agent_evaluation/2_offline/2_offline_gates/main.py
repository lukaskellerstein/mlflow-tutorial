...
is the other mode, and it has its own lesson: L2-M2.3.1 (Online Scoring).

Builds on L2-M2.1.1 (Test Generation), L2-M2.1.2 (Judges) and L2-M2.1.3 (Quality
Metrics).
"""
...
def main() -> None:
    ...
    print("  Experiment: L2/M2_agent_evaluation/2_offline/2_offline_gates")
    print("=" * 60)
    print("\n  This answered 'good enough to ship?'. For 'is what shipped still")
    print("  good?', continue to L2-M2.3.1 — Online Scoring on Production Traces.")
