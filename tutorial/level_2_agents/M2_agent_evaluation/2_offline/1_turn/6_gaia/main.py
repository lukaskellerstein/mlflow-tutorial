...
Tracing is hand-built (the L2-M1.1.3 pattern): @mlflow.trace opens the
...
async def main() -> None:
    print("=" * 60)
    print("L2-M2.2.1.6 -- GAIA General Assistant Benchmark")
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    mlflow.set_experiment("L2/M2_agent_evaluation/2_offline/1_turn/6_gaia")
    anyio.run(main)
