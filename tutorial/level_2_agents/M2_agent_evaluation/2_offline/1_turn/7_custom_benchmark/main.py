...
(the L2-M1.1.3 pattern): @mlflow.trace per task, a child span per
tool call.
"""
...
def build_options(effort: EffortLevel) -> ClaudeAgentOptions:
    """Agent options for one configuration -- see L2-M2.2.1.3 for why the
...
async def main() -> None:
    print("=" * 60)
    print("L2-M2.2.1.7 -- Custom Domain-Specific Agent Benchmark")
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    mlflow.set_experiment("L2/M2_agent_evaluation/2_offline/1_turn/7_custom_benchmark")
    anyio.run(main)
