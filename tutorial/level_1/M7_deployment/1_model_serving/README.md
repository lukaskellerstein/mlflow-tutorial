...
```bash
cd tutorial/level_1/M7_deployment/1_model_serving
uv sync
...
- Experiment "L1/M7_deployment/1_model_serving" with one run
...
Continue to L1-M7.2 (AI Gateway Overview) to learn how MLflow can route
