...
- Completed: L1-M5.1 (Prompt Registry), L1-M5.2 (Scorers and Judges)
...
```bash
cd tutorial/level_1/M5_genai_features/3_datasets_labeling
uv sync
...
============================================================
  ...
  Navigate to experiment: L1/M5_genai_features/3_datasets_labeling
...
In L1-M6.1 (Dataset Logging and Lineage), we'll explore MLflow's broader data tracking capabilities beyond GenAI. In Level 2 (M3.4), we'll build full human-in-the-loop labeling pipelines with iterative refinement.
