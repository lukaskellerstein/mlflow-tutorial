...
- Completed: L1-M3.1 (Models and Flavors), L1-M3.2 (Model Registry)
...
```bash
cd tutorial/level_1/M3_models/3_model_serving
uv sync
...
- Experiment "L1/M3_models/3_model_serving" with one run
...
Continue to L1-M4 (Evaluations) to learn how to evaluate LLM outputs
with built-in and custom metrics. In Level 2, we will explore advanced
serving patterns including custom endpoints and deployment strategies.
