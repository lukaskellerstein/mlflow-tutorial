...
small model here (gemma4:e2b) to keep things fast; in practice
...
def generate_answer(student: ChatOllama, question: str) -> str:
...
def judge_answer(
    judge: ChatOllama, question: str, ground_truth: str, model_answer: str
) -> dict:
