...
```bash
cd tutorial/level_1/M8_deployment/2_ai_gateway
uv sync
...
In the MLflow UI, open the experiment "L1/M8_deployment/2_ai_gateway" to see:
...
Continue to **L1-9.1 (MLflow Projects)** to learn how to package reproducible ML workflows. In **Level 2 (L2-M7)**, we'll set up a live gateway with real provider routing, fallback chains, and load balancing.
