...
Autologging (L1-M2.1) captures framework calls automatically. But your own code — data processing, validation, orchestration logic — needs manual instrumentation. This lesson shows two manual tracing APIs and how to combine them with autologging for a unified view.

## Prerequisites

- Completed: L1-M2.1 (Autologging and Auto-Tracing)
...
```bash
cd tutorial/level_1/M2_tracing/2_manual_tracing
uv sync
...
Continue to **L1-M3.1 (Models and Flavors)** to learn how MLflow packages models into a portable, self-describing format with different flavors.
