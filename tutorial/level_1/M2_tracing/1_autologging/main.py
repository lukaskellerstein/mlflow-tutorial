...
def part4_search_traces() -> None:
    ...
    experiment = mlflow.get_experiment_by_name("L1/M2_tracing/1_autologging")
...
def main() -> None:
    ...
    print()
    print("Navigate to experiment 'L1/M2_tracing/1_autologging'")
...
if __name__ == "__main__":
    ...
    mlflow.set_experiment("L1/M2_tracing/1_autologging")
