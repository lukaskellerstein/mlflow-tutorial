...
```bash
cd tutorial/level_1/M6_genai_features/1_prompt_registry
uv sync
...
In the next lesson (L1-M6.2 Scorers and Judges), you will learn how to evaluate LLM outputs using built-in and custom scoring functions. In Level 2, we will explore prompt A/B testing and automated prompt optimization.
