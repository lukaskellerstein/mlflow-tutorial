...
```bash
cd tutorial/level_1/M6_genai_features/2_scorers_judges
uv sync
...
Continue to L1-6.3 (Datasets and Labeling) to learn how to manage evaluation datasets and capture human feedback. In Level 2, we will explore this in more depth with custom metrics, RAG evaluation, and human-in-the-loop workflows.
