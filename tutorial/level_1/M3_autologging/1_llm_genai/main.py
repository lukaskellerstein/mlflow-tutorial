...
def part1_simple_llm_call(llm: ChatOpenAI) -> None:
...
def part2_chain_with_prompt(llm: ChatOpenAI) -> None:
    ...
    print()
    print("  [Autolog captured]")
    print("    - Full chain: PromptTemplate -> ChatOpenAI -> StrOutputParser")
...
def part3_multi_step_chain(llm: ChatOpenAI) -> None:
