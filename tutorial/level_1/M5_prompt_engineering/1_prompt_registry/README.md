...
```bash
cd tutorial/level_1/M5_prompt_engineering/1_prompt_registry
uv sync
...
In the next lesson (L1-M5.2 Prompt Management at Scale), you will learn how to A/B test prompt variants and use versioning strategies for team collaboration.
