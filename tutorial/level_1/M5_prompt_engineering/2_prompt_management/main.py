"""L1-M5.2 — Prompt Management at Scale: versioning, A/B testing, comparison."""
...
mlflow.set_experiment("L1/M5_prompt_engineering/2_prompt_management")
...
def main() -> None:
    ...
    print("  Experiment: L1/M5_prompt_engineering/2_prompt_management")
