...
- Completed: L1-M5.1 (Prompt Registry)
...
```bash
cd tutorial/level_1/M5_prompt_engineering/2_prompt_management
uv sync
...
- **Experiment**: `L1/M5_prompt_engineering/2_prompt_management`
...
In L1-M5.3 (Prompt Optimization), you will go beyond manual A/B testing and explore systematic prompt tuning, using evaluation metrics as the optimization target.
